...
export class SongtextFormatter {
    private tempFile: string = config.printer.tempFile || '/tmp/printFile.png';
    private template: string = fs.readFileSync('dist/app/templates/SongPrint.html', 'utf8');
    private options: any = { // Don't change these values except you know what you're doing!!
        screenSize: {
